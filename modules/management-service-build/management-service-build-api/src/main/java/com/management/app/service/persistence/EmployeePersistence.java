...
public interface EmployeePersistence extends BasePersistence<Employee> {
	 ...
	 * @return the matching employees
	 */
	public java.util.List<Employee> findByemployee(long companyId);
	 ...
	 * @return the range of matching employees
	 */
	public java.util.List<Employee> findByemployee(
	 ...
	 * @return the matching employees
	 */
	public java.util.List<Employee> findByC_E_S(int status);
	 ...
	 * @return the range of matching employees
	 */
	public java.util.List<Employee> findByC_E_S(int status, int start, int end);
	 ...
	 * @return the ordered range of matching employees
	 */
	public java.util.List<Employee> findByC_E_S(
	 ...
	 * @return the matching employees
	 */
	public java.util.List<Employee> findByF_L_C(
