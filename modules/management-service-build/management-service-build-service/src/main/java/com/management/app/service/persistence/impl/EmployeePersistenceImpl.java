...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByemployee(long companyId) {
	 ...
	 */
	@Override
	public List<Employee> findByemployee(long companyId, int start, int end) {
		return findByemployee(companyId, start, end, null);
	}
	...
	public List<Employee> findByemployee(
		...
		return findByemployee(companyId, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByemployee(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_EMPLOYEE_COMPANYID_2);
	 ...
	 */
	@Override
	public Employee findByemployee_First(
			long companyId, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByemployee_First(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByemployee_First(
		long companyId, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByemployee(
	 ...
	 */
	@Override
	public Employee findByemployee_Last(
			long companyId, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByemployee_Last(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByemployee_Last(
		long companyId, OrderByComparator<Employee> orderByComparator) {

		int count = countByemployee(companyId);
	 ...
	 */
	@Override
	public Employee[] findByemployee_PrevAndNext(
	...
	protected Employee getByemployee_PrevAndNext(
	 ...
	 */
	@Override
	public void removeByemployee(long companyId) {
		for (Employee employee :
				findByemployee(
					companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByemployee(long companyId) {
	...
	private static final String _FINDER_COLUMN_EMPLOYEE_COMPANYID_2 =
		"employee.companyId = ?";
	...
	/**
	 * Returns the employee where employeeId = &#63; and companyId = &#63; or throws a <code>NoSuchEmployeeException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public Employee findByemployeeId(long employeeId, long companyId)
		throws NoSuchEmployeeException {

		Employee employee = fetchByemployeeId(employeeId, companyId);
	...
	/**
	 * Returns the employee where employeeId = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param employeeId the employee ID
	 * @param companyId the company ID
	 * @return the matching employee, or <code>null</code> if a matching employee could not be found
	 */
	@Override
	public Employee fetchByemployeeId(long employeeId, long companyId) {
		return fetchByemployeeId(employeeId, companyId, true);
	}

	/**
	 * Returns the employee where employeeId = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param employeeId the employee ID
	 * @param companyId the company ID
	 * @param useFinderCache whether to use the finder cache
	 ...
	 */
	@Override
	public Employee fetchByemployeeId(
		long employeeId, long companyId, boolean useFinderCache) {
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_EMPLOYEEID_COMPANYID_2);
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"EmployeePersistenceImpl.fetchByemployeeId(long, long, boolean) with parameters (" +
	...
	/**
	 * Removes the employee where employeeId = &#63; and companyId = &#63; from the database.
	 *
	 * @param employeeId the employee ID
	 * @param companyId the company ID
	 * @return the employee that was removed
	 */
	@Override
	public Employee removeByemployeeId(long employeeId, long companyId)
		throws NoSuchEmployeeException {

		Employee employee = findByemployeeId(employeeId, companyId);

		return remove(employee);
	}

	/**
	 * Returns the number of employees where employeeId = &#63; and companyId = &#63;.
	 *
	 * @param employeeId the employee ID
	 * @param companyId the company ID
	 * @return the number of matching employees
	 */
	@Override
	public int countByemployeeId(long employeeId, long companyId) {
	...
	private static final String _FINDER_COLUMN_EMPLOYEEID_COMPANYID_2 =
		"employee.companyId = ?";
	...
	/**
	 * Returns all the employees where status &ne; &#63;.
	 *
	 * @param status the status
	 * @return the matching employees
	 */
	@Override
	public List<Employee> findByC_E_S(int status) {
		return findByC_E_S(status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the employees where status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByC_E_S(int status, int start, int end) {
		return findByC_E_S(status, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employees where status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Employee> findByC_E_S(
		int status, int start, int end,
		OrderByComparator<Employee> orderByComparator) {

		return findByC_E_S(status, start, end, orderByComparator, true);
	}
	...
	/**
	 * Returns the first employee in the ordered set where status &ne; &#63;.
	 *
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching employee
	 ...
	 */
	@Override
	public Employee findByC_E_S_First(
			int status, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByC_E_S_First(status, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByC_E_S_First(
		int status, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByC_E_S(status, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employee in the ordered set where status &ne; &#63;.
	 *
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching employee
	 ...
	 */
	@Override
	public Employee findByC_E_S_Last(
			int status, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByC_E_S_Last(status, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByC_E_S_Last(
		int status, OrderByComparator<Employee> orderByComparator) {

		int count = countByC_E_S(status);

		if (count == 0) {
			return null;
		}

		List<Employee> list = findByC_E_S(
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where status &ne; &#63;.
	 *
	 * @param employeeId the primary key of the current employee
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employee[] findByC_E_S_PrevAndNext(
	...
	protected Employee getByC_E_S_PrevAndNext(
	...
	/**
	 * Removes all the employees where status &ne; &#63; from the database.
	 *
	 * @param status the status
	 */
	@Override
	public void removeByC_E_S(int status) {
		for (Employee employee :
				findByC_E_S(
	...
	/**
	 * Returns the number of employees where status &ne; &#63;.
	 *
	 * @param status the status
	 * @return the number of matching employees
	 */
	@Override
	public int countByC_E_S(int status) {
		FinderPath finderPath = _finderPathWithPaginationCountByC_E_S;
	...
	private FinderPath _finderPathWithPaginationFindByF_L_C;
	private FinderPath _finderPathWithoutPaginationFindByF_L_C;
	private FinderPath _finderPathCountByF_L_C;

	/**
	 * Returns all the employees where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Employee> findByF_L_C(
		String firstName, String lastName, long companyId) {

		return findByF_L_C(
			firstName, lastName, companyId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the employees where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Employee> findByF_L_C(
		String firstName, String lastName, long companyId, int start, int end) {

		return findByF_L_C(firstName, lastName, companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employees where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	...
	public List<Employee> findByF_L_C(
		...
		return findByF_L_C(
			firstName, lastName, companyId, start, end, orderByComparator,
			true);
	}
	...
	public List<Employee> findByF_L_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByF_L_C;
				finderArgs = new Object[] {firstName, lastName, companyId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByF_L_C;
			finderArgs = new Object[] {
				firstName, lastName, companyId, start, end, orderByComparator
			};
		}
	...
	/**
	 * Returns the first employee in the ordered set where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Employee findByF_L_C_First(
			String firstName, String lastName, long companyId,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByF_L_C_First(
			firstName, lastName, companyId, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByF_L_C_First(
		String firstName, String lastName, long companyId,
		OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByF_L_C(
			firstName, lastName, companyId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employee in the ordered set where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Employee findByF_L_C_Last(
			String firstName, String lastName, long companyId,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByF_L_C_Last(
			firstName, lastName, companyId, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByF_L_C_Last(
		String firstName, String lastName, long companyId,
		OrderByComparator<Employee> orderByComparator) {

		int count = countByF_L_C(firstName, lastName, companyId);
		...
		List<Employee> list = findByF_L_C(
			firstName, lastName, companyId, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * @param employeeId the primary key of the current employee
	 * @param firstName the first name
	 * @param lastName the last name
	 ...
	 */
	@Override
	public Employee[] findByF_L_C_PrevAndNext(
			long employeeId, String firstName, String lastName, long companyId,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
		...
		try {
			...
			array[0] = getByF_L_C_PrevAndNext(
				session, employee, firstName, lastName, companyId,
				orderByComparator, true);

			array[1] = employee;

			array[2] = getByF_L_C_PrevAndNext(
				session, employee, firstName, lastName, companyId,
	...
	protected Employee getByF_L_C_PrevAndNext(
	...
	/**
	 * Removes all the employees where firstName = &#63; and lastName = &#63; and companyId = &#63; from the database.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	...
	/**
	 * Returns the number of employees where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	...
	public void cacheResult(Employee employee) {
		...
		finderCache.putResult(
			...
			new Object[] {employee.getEmployeeId(), employee.getCompanyId()},
			employee);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			employeeModelImpl.getEmployeeId(), employeeModelImpl.getCompanyId()
		};
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByemployee = new FinderPath(
		...
		_finderPathWithoutPaginationFindByemployee = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByemployee",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			true);

		_finderPathCountByemployee = new FinderPath(
		...
		_finderPathFetchByemployeeId = new FinderPath(
			...
			new String[] {"employeeId", "companyId"}, true);

		_finderPathCountByemployeeId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByemployeeId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"employeeId", "companyId"}, false);
		...
		_finderPathWithPaginationFindByF_L_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_L_C",
			new String[] {
		...
		_finderPathWithoutPaginationFindByF_L_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_L_C",
			new String[] {
				String.class.getName(), String.class.getName(),
				Long.class.getName()
			},
