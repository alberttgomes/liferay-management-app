...
public class ManagerPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBymanager;
	private FinderPath _finderPathWithoutPaginationFindBymanager;
	private FinderPath _finderPathCountBymanager;
	 ...
	 */
	@Override
	public List<Manager> findBymanager(long companyId) {
	 ...
	 */
	@Override
	public List<Manager> findBymanager(long companyId, int start, int end) {
		return findBymanager(companyId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Manager> findBymanager(
		long companyId, int start, int end,
		OrderByComparator<Manager> orderByComparator) {

		return findBymanager(companyId, start, end, orderByComparator, true);
	}
	...
	public List<Manager> findBymanager(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBymanager;
				finderArgs = new Object[] {companyId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBymanager;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_MANAGER_COMPANYID_2);
	 ...
	 */
	@Override
	public Manager findBymanager_First(
			long companyId, OrderByComparator<Manager> orderByComparator)
		throws NoSuchManagerException {

		Manager manager = fetchBymanager_First(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Manager fetchBymanager_First(
		long companyId, OrderByComparator<Manager> orderByComparator) {

		List<Manager> list = findBymanager(companyId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Manager findBymanager_Last(
			long companyId, OrderByComparator<Manager> orderByComparator)
		throws NoSuchManagerException {

		Manager manager = fetchBymanager_Last(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Manager fetchBymanager_Last(
		long companyId, OrderByComparator<Manager> orderByComparator) {

		int count = countBymanager(companyId);

		if (count == 0) {
			return null;
		}

		List<Manager> list = findBymanager(
	 ...
	 */
	@Override
	public Manager[] findBymanager_PrevAndNext(
		...
		try {
			...
			array[0] = getBymanager_PrevAndNext(
				session, manager, companyId, orderByComparator, true);

			array[1] = manager;

			array[2] = getBymanager_PrevAndNext(
	...
	protected Manager getBymanager_PrevAndNext(
	 ...
	 */
	@Override
	public void removeBymanager(long companyId) {
		for (Manager manager :
				findBymanager(
					companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countBymanager(long companyId) {
		FinderPath finderPath = _finderPathCountBymanager;
	...
	private static final String _FINDER_COLUMN_MANAGER_COMPANYID_2 =
		"manager.companyId = ?";

	private FinderPath _finderPathFetchBymanagerId;
	private FinderPath _finderPathCountBymanagerId;

	/**
	 * Returns the manager where managerId = &#63; and companyId = &#63; or throws a <code>NoSuchManagerException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public Manager findBymanagerId(long managerId, long companyId)
		throws NoSuchManagerException {

		Manager manager = fetchBymanagerId(managerId, companyId);
	...
	/**
	 * Returns the manager where managerId = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param managerId the manager ID
	 * @param companyId the company ID
	 * @return the matching manager, or <code>null</code> if a matching manager could not be found
	 */
	@Override
	public Manager fetchBymanagerId(long managerId, long companyId) {
		return fetchBymanagerId(managerId, companyId, true);
	}

	/**
	 * Returns the manager where managerId = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param managerId the manager ID
	 * @param companyId the company ID
	 * @param useFinderCache whether to use the finder cache
	 ...
	 */
	@Override
	public Manager fetchBymanagerId(
		long managerId, long companyId, boolean useFinderCache) {

		Object[] finderArgs = null;

		if (useFinderCache) {
			finderArgs = new Object[] {managerId, companyId};
		}
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchBymanagerId, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_MANAGERID_COMPANYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchBymanagerId, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ManagerPersistenceImpl.fetchBymanagerId(long, long, boolean) with parameters (" +
	...
	/**
	 * Removes the manager where managerId = &#63; and companyId = &#63; from the database.
	 *
	 * @param managerId the manager ID
	 * @param companyId the company ID
	 * @return the manager that was removed
	 */
	@Override
	public Manager removeBymanagerId(long managerId, long companyId)
		throws NoSuchManagerException {

		Manager manager = findBymanagerId(managerId, companyId);

		return remove(manager);
	}

	/**
	 * Returns the number of managers where managerId = &#63; and companyId = &#63;.
	 *
	 * @param managerId the manager ID
	 * @param companyId the company ID
	 * @return the number of matching managers
	 */
	@Override
	public int countBymanagerId(long managerId, long companyId) {
		FinderPath finderPath = _finderPathCountBymanagerId;

		Object[] finderArgs = new Object[] {managerId, companyId};
	...
	private FinderPath _finderPathFetchByE_M_C;
	private FinderPath _finderPathCountByE_M_C;
	 ...
	 */
	@Override
	public Manager findByE_M_C(long managerId, long companyId)
		throws NoSuchManagerException {

		Manager manager = fetchByE_M_C(managerId, companyId);
	 ...
	 */
	@Override
	public Manager fetchByE_M_C(long managerId, long companyId) {
		return fetchByE_M_C(managerId, companyId, true);
	}
	...
	public Manager fetchByE_M_C(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByE_M_C, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_E_M_C_MANAGERID_2);

			sb.append(_FINDER_COLUMN_E_M_C_COMPANYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByE_M_C, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ManagerPersistenceImpl.fetchByE_M_C(long, long, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	 ...
	 */
	@Override
	public Manager removeByE_M_C(long managerId, long companyId)
		throws NoSuchManagerException {

		Manager manager = findByE_M_C(managerId, companyId);
	 ...
	 */
	@Override
	public int countByE_M_C(long managerId, long companyId) {
		FinderPath finderPath = _finderPathCountByE_M_C;
	...
	private static final String _FINDER_COLUMN_E_M_C_MANAGERID_2 =
		"manager.managerId = ? AND ";

	private static final String _FINDER_COLUMN_E_M_C_COMPANYID_2 =
		"manager.companyId = ?";

	private FinderPath _finderPathFetchByF_L_C;
	private FinderPath _finderPathCountByF_L_C;

	/**
	 * Returns the manager where firstName = &#63; and lastName = &#63; and companyId = &#63; or throws a <code>NoSuchManagerException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public Manager findByF_L_C(
			String firstName, String lastName, long companyId)
		throws NoSuchManagerException {

		Manager manager = fetchByF_L_C(firstName, lastName, companyId);
	...
	/**
	 * Returns the manager where firstName = &#63; and lastName = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Manager fetchByF_L_C(
		String firstName, String lastName, long companyId) {

		return fetchByF_L_C(firstName, lastName, companyId, true);
	}

	/**
	 * Returns the manager where firstName = &#63; and lastName = &#63; and companyId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	...
	public Manager fetchByF_L_C(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {firstName, lastName, companyId};
		}
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByF_L_C, finderArgs, this);
		}

		if (result instanceof Manager) {
			Manager manager = (Manager)result;

			if (!Objects.equals(firstName, manager.getFirstName()) ||
				!Objects.equals(lastName, manager.getLastName()) ||
				(companyId != manager.getCompanyId())) {
		...
		if (result == null) {
			...
			if (firstName.isEmpty()) {
				sb.append(_FINDER_COLUMN_F_L_C_FIRSTNAME_3);
			}
			else {
				bindFirstName = true;

				sb.append(_FINDER_COLUMN_F_L_C_FIRSTNAME_2);
			}

			boolean bindLastName = false;

			if (lastName.isEmpty()) {
				sb.append(_FINDER_COLUMN_F_L_C_LASTNAME_3);
			}
			else {
				bindLastName = true;

				sb.append(_FINDER_COLUMN_F_L_C_LASTNAME_2);
			}

			sb.append(_FINDER_COLUMN_F_L_C_COMPANYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByF_L_C, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ManagerPersistenceImpl.fetchByF_L_C(String, String, long, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	/**
	 * Removes the manager where firstName = &#63; and lastName = &#63; and companyId = &#63; from the database.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Manager removeByF_L_C(
			String firstName, String lastName, long companyId)
		throws NoSuchManagerException {

		Manager manager = findByF_L_C(firstName, lastName, companyId);

		return remove(manager);
	}

	/**
	 * Returns the number of managers where firstName = &#63; and lastName = &#63; and companyId = &#63;.
	 *
	 * @param firstName the first name
	 * @param lastName the last name
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public int countByF_L_C(String firstName, String lastName, long companyId) {
		firstName = Objects.toString(firstName, "");
		lastName = Objects.toString(lastName, "");

		FinderPath finderPath = _finderPathCountByF_L_C;

		Object[] finderArgs = new Object[] {firstName, lastName, companyId};
	...
	private static final String _FINDER_COLUMN_F_L_C_FIRSTNAME_2 =
		"manager.firstName = ? AND ";

	private static final String _FINDER_COLUMN_F_L_C_FIRSTNAME_3 =
		"(manager.firstName IS NULL OR manager.firstName = '') AND ";

	private static final String _FINDER_COLUMN_F_L_C_LASTNAME_2 =
		"manager.lastName = ? AND ";

	private static final String _FINDER_COLUMN_F_L_C_LASTNAME_3 =
		"(manager.lastName IS NULL OR manager.lastName = '') AND ";

	private static final String _FINDER_COLUMN_F_L_C_COMPANYID_2 =
		"manager.companyId = ?";
	...
	public void cacheResult(Manager manager) {
		...
		finderCache.putResult(
			_finderPathFetchBymanagerId,
			new Object[] {manager.getManagerId(), manager.getCompanyId()},
			manager);

		finderCache.putResult(
			_finderPathFetchByE_M_C,
			new Object[] {manager.getManagerId(), manager.getCompanyId()},
			manager);

		finderCache.putResult(
			_finderPathFetchByF_L_C,
			new Object[] {
	...
	protected void cacheUniqueFindersCache(ManagerModelImpl managerModelImpl) {
		...
		args = new Object[] {
			managerModelImpl.getManagerId(), managerModelImpl.getCompanyId()
		};

		finderCache.putResult(
			_finderPathCountBymanagerId, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchBymanagerId, args, managerModelImpl);

		args = new Object[] {
			managerModelImpl.getManagerId(), managerModelImpl.getCompanyId()
		};

		finderCache.putResult(_finderPathCountByE_M_C, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByE_M_C, args, managerModelImpl);

		args = new Object[] {
			managerModelImpl.getFirstName(), managerModelImpl.getLastName(),
			managerModelImpl.getCompanyId()
		};

		finderCache.putResult(_finderPathCountByF_L_C, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByF_L_C, args, managerModelImpl);
	}
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBymanager = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBymanager",
			new String[] {
		...
		_finderPathWithoutPaginationFindBymanager = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBymanager",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			true);

		_finderPathCountBymanager = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBymanager",
			new String[] {Long.class.getName()}, new String[] {"companyId"},
			false);

		_finderPathFetchBymanagerId = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchBymanagerId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"managerId", "companyId"}, true);

		_finderPathCountBymanagerId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBymanagerId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"managerId", "companyId"}, false);

		_finderPathFetchByE_M_C = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByE_M_C",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"managerId", "companyId"}, true);

		_finderPathCountByE_M_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByE_M_C",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"managerId", "companyId"}, false);

		_finderPathFetchByF_L_C = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByF_L_C",
			new String[] {
				String.class.getName(), String.class.getName(),
				Long.class.getName()
			},
			new String[] {"firstName", "lastName", "companyId"}, true);

		_finderPathCountByF_L_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_L_C",
			new String[] {
				String.class.getName(), String.class.getName(),
				Long.class.getName()
			},
			new String[] {"firstName", "lastName", "companyId"}, false);
