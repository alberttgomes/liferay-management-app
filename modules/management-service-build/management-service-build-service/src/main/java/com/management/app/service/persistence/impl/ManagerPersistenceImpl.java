...
public class ManagerPersistenceImpl
	...
	public Manager findByF_L(String firstName, String lastName)
		...
		Manager manager = fetchByF_L(firstName, lastName);
	...
	public Manager fetchByF_L(String firstName, String lastName) {
		return fetchByF_L(firstName, lastName, true);
	}
	...
	public Manager fetchByF_L(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByF_L, finderArgs, this);
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ManagerPersistenceImpl.fetchByF_L(String, String, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	public Manager removeByF_L(String firstName, String lastName)
		...
		Manager manager = findByF_L(firstName, lastName);
	...
	private static final String _FINDER_COLUMN_F_L_LASTNAME_3 =
		"(manager.lastName IS NULL OR manager.lastName = '')";
	...
	protected void cacheUniqueFindersCache(ManagerModelImpl managerModelImpl) {
		...
		finderCache.putResult(_finderPathCountByF_L, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByF_L, args, managerModelImpl);
	}
