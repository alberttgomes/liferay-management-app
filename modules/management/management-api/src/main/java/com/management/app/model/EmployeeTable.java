...
public class EmployeeTable extends BaseTable<EmployeeTable> {
	...
	public final Column<EmployeeTable, Long> createByUserId = createColumn(
		"createByUserId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	...
	public final Column<EmployeeTable, Long> managerIdFK = createColumn(
		"managerIdFK", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
